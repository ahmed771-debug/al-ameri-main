...
const UserTrainer = () => {
  ...
  const handleTrainerClick = (
    ...
    if (isDisabled) return; // Prevent click if the item is disabled
        ...
        {trainers?.map((trainer: any, index: number) => {
          ...
          return (
            <div
              ...
              } max-w-[20rem] break-words`} // Disable click and change appearance
            >
              <video
                className="mb-2"
                controls={!isDisabled} // Disable video controls if disabled
                width="320"
                height="140"
